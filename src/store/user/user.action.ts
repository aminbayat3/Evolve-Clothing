...
import { USER_ACTIONS_TYPES, EmailSignIn, SignUp } from './user.types';
...
export type SignUpStart = ActionWithPayload<USER_ACTIONS_TYPES.SIGN_UP_START, SignUp>;

export type SignUpSuccess = ActionWithPayload<USER_ACTIONS_TYPES.SIGN_UP_SUCCESS, {user: User, additionalDetails: AdditionalData}>;
...
export const signInSuccess = withMatcher((user: UserData & { id: string }): SignInSuccess => createAction(USER_ACTIONS_TYPES.SIGN_IN_SUCCESS, user));
...
export const signUpSuccess = withMatcher((user: User, additionalDetails: AdditionalData): SignUpSuccess => createAction(USER_ACTIONS_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails }));
